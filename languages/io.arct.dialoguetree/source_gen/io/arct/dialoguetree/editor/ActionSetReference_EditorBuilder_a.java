...
/*package*/ class ActionSetReference_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ActionSetReference_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_y0umxy_a");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.actions$yufw;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.actions$yufw);
    }
