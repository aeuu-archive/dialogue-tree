...
/*package*/ class ReturnAction_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ReturnAction_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_dagmxv_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_dagmxv_a0");
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.value$u3Sw;
  ...
  private static final class PROPS {
    /*package*/ static final SProperty value$u3Sw = MetaAdapterFactory.getProperty(0x200ef616249d4ed7L, 0x9810cbdeaf100067L, 0x56f13ba7056e10b4L, 0x56f13ba7056e10b5L, "value");
  }
